...
exports.db = void 0;
var db_config_1 = __importDefault(require("../config/db.config")); // assuming export default is used in db.config.ts
...
var stakeholder_model_1 = __importDefault(require("./stakeholder.model"));
var userinfo_model_1 = __importDefault(require("./userinfo.model"));
exports.db = {
